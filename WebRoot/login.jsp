...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="http://html.moko.hk/css/36!button.css" rel="stylesheet" type="text/css" />
		<link href="http://html.moko.hk/css/75!base1.css" rel="stylesheet" type="text/css" />
		<link href="http://html.moko.hk/css/81!publicSkin.css" rel="stylesheet" type="text/css" />
		<link href="http://html.moko.hk/css/79!layout.css" rel="stylesheet" type="text/css" />
		<link href="http://html.moko.hk/css/66!login.css" rel="stylesheet" type="text/css" />
		<link href="http://html.moko.hk/css/1!email-suggest.css" rel="stylesheet" type="text/css" />
		...
		<link href="styles/moaoyo/button.css" rel="stylesheet" type="text/css" />
		<link href="styles/moaoyo/base1.css" rel="stylesheet" type="text/css" />
		<link href="styles/moaoyo/publicSkin.css" rel="stylesheet" type="text/css" />
		<link href="styles/moaoyo/layout.css" rel="stylesheet" type="text/css" />
		<link href="styles/moaoyo/login.css" rel="stylesheet" type="text/css" />
		<link href="styles/moaoyo/email-suggest.css" rel="stylesheet" type="text/css" />
...
<body>
		...
		<div id="topman" class="moko-nav">
			<div class="moko-nav-width">
				...
				<script type="text/javascript">jQuery1.setCss("nav_login","active",true);</script>
		...
		<div class="wrap">
			<div class="header">
				<a href="/">
					<img class="logo" src="http://html.moko.hk/images/logo2011_3.gif" />
				</a>
			</div>
			<input type="hidden" id = "login-toUrl" name = "tourl" value = "http://www.moko.cc/"/>
			<input type="hidden" id = "login-errorInfo" value = ""/>
			<div class="login-article" id="login-div">
				<!--登录表单 begin-->
				<div class="login-section">
					<h1 class="login-big-label">登入</h1>
					<form method="post" id="login-loginForm" name="loginForm" onkeydown="jQuery1.mk.login.enter(event, false);">
					<div class="login-content">
						<ul>
							<li class="login-message">
								<label for="login-email">Email:</label>
								<p>
									<input class="text" type="text" id="login-email" name="usermingzi" value="" autocomplete="off" />
								</p>
								<div class="login-tip" style="display:none" id="login-tip">
									<img class="arrow_4" src="http://html.moko.hk/images/n.gif" />
									<a href="javascript:void(0);" class="sDel_3" src="http://html.moko.hk/images/n.gif" title="关闭" alt="关闭" onclick="jQuery1.mk.login.closeErrorAlert()"></a>
									<h4 class="error-title" id="login-tip-error-title">登录名或密码错误!</h4>
									<ul id="login-tip-error-content">
										<li>1.登录邮箱是否正确</li>
										<li>2.密码大小写是否正确</li>
										<li>3.忘记密码了！点击&gt;<a href="/getpassword.html" title="找回密码" hidefocus="true">这里</a></li>
									</ul>
								</div>
							</li>
							<li>
								<label for="login-pass">密&nbsp;&nbsp;码:</label>
								<p>
									<input class="text" type="password" name="userkey" id="login-pass" />
								</p>
							</li>
							<li class="login-ctrl">
								<p>
									<span class="login-remeber-pass"><input id="login-remeber-pass" name="isremember" type="checkbox"/><label for="login-remeber-pass" hidefocus="true">记住登录状态</label></span>
									<span class="login-forgot-pass"><a href="/getpassword.html" title="找回密码" hidefocus="true">忘记密码？</a></span>
								</p>
							</li>
							<li>
								<p>
									<input id="login-btnLogin" onclick="jQuery1.mk.login.checkLogin();" class="btn" onfocus="blur();" type="button" value="登 录" />
								</p>
								<div id="login-logining" class="logining" style="display:none;">登录中...</div>
							</li>
							<li>
								<p>
									<input class="btn gC" onfocus="blur();" type="button" value="注 册" onclick="jQuery1.location('/register/first.html');" />
								</p>
							</li>
						</ul>
						<div class="other-login">
							<label>其他登录方式：</label>
							<p><input class="btn sina" onfocus="blur();" type="button" value="" onclick="jQuery1.mk.bd.bindSina('nologin');" /></p>
							<p>
								<input class="btn qq" onfocus="blur();" type="button" value="" onclick="jQuery1.mk.bd.bindQQ('https://graph.qq.com/oauth2.0/authorize?scope=get_user_info,add_share,add_weibo&response_type=code&client_id=100226571&redirect_uri=http://www.moko.cc/qq/callback&state=nologin');" />
							</p>
						</div>
					</div>
					</form>
				...
				<!--登录表单 end-->
				<img id="login-mokoman" class="mokoman" src="http://html.moko.hk/images/n.gif" />
			</div>
