  ...
  <body>
   <div id="content">
	<!-- <div id="banner"></div> -->
		<!--banner-->
		<div id="zhuti">
			<form  action="saveTmpMg.action" method="post" class="x-form">
				  	...
				  	<legend>添加模板</legend>
			  	 		<table width = "550">
			  	 			<tr>
			  	 				...
			  	 				<td><input type="text" id="sms1" name="template_id" />*</td>
			  	 				<td align="right">模板文件：</td>
			  	 				<td><input type="file" name="template_fname" /></td>
			  	 			</tr>
			  	 			<tr>
			  	 				<td align="right">模板名称：</td>
			  	 				<td><input id="sms2" name="template_name" type="text" /></td>
			  	 				<td align="right">校验文件：</td>
			  	 				<td><input type="file" name = "check_tmp_file"/></td>
			  	 			</tr>
			  	 			<tr>
			  	 				<td align="right">模板格式：</td>
			  	 				<td>
			  	 					<select name="template_format" id = "sms3">
			  	 						<option>ADF</option>
			  	 				...
			  	 				<td><input type="file"  name="ca_file"/></td>
			  	 			</tr>
			  	 			<tr>
			  	 				<td align="right">文本数量：</td>
			  	 				<td><input type="text" id="sms4" name="msg_number" /></td>
			  	 				<td align="right">账单存储文件：</td>
			  	 				<td><input type="file" name="vault_tmp_file"/></td>
			  	 			</tr>
			  	 			<tr>
			  	 				<td align="right">图片数量：</td>
			  	 				<td><input id="sms5" name="pic_number" type="text"/></td>
			  	 				<td align="right">电子账单存储文件：</td>
			  	 				<td><input type="file" name = "mail_tmp_file"/></td>
			  	 			</tr>
			  	 			<tr>
			  	 				<td align="right">模板描述：</td>
			  	 				<td><input id="sms6" name="tmp_desc" type="text" /></td>
			  	 			</tr>
			  	 		</table>
                  </fieldset>
