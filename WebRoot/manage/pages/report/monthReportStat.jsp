				  ...
				  <fieldset>
				  	<legend>账单统计查询条件</legend>
			  	 		<div class = "x-form-item">
			  	 			<label for = "billMonthDate"><div align="right">账单月：</div></label>
			  	 			<input id = "billMonthDate" name = "billDate" type = "text" value = "">
			  	 		</div>
			  	 		<div class="x-form-item">					
						<label for="billMonthStattype"><div align="right">账单统计类型：</div></label>
					    <select id="billMonthStattype">
					    	<option value="0" selected>账单制作统计月报表</option>
							<option value="1">账单页数统计月报表</option>
							<option value="2">电子账单发送统计月报表</option>
							<option value="3">数据处理月报表</option>
						</select>
					</div>
				  </fieldset>
