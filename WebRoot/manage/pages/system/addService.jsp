  ...
  <body>
   <div id="content">
	<!-- <div id="banner"></div> -->
		<!--banner-->
		<div id="zhuti">
			<form  action="savePintInst.action" method="post" class="x-form">
				  	...
				  	<legend>增加服务商</legend>
			  	 		<table width="500">
				  			<tr>
				  				...
				  				<td><input type = "text" id = "sms1" name = "institution_id"/></td>
				  				<td align="right">服务商名称：</td>
				  				<td><input type = "text" id = "sms2" name = "institution_name"/></td>
				  			</tr>
				  			<tr>
				  			<td align="right">服务商状态：</td>
				  				<td><input type = "text" id = "sms3" name = "institution_state"/></td>
				  				<td align="right">FTP服务器：</td>
				  				<td><input type = "text" id = "sms4" name = "ftp_server"/></td>
				  			</tr>
				  			<tr>
				  				<td align="right">服务商用户名：</td>
				  				<td><input type = "text" id = "sms5" name = "user_name"/></td>
				  				<td align="right">服务商密码：</td>
				  				<td><input type = "text" id = "sms6" name = "user_pws"/></td>
				  			</tr>
