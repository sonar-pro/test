  ...
  <body>
   <div id="content">
	<!-- <div id="banner"></div> -->
		<!--banner-->
		<div id="zhuti">
			<form action="deptUpdate.action" method="post" class="x-form">
				  ...
				  <fieldset>
				  	<legend>修改部门</legend>
				  		<div>
				  			...
				  			<input id = "sms1" name = "dept_id" type = "text"  value = "${dept.deptId}" />
				  		</div>
				  		<div>
				  			<label for="x-form-item">部门名称：</label>
				  			<input id = "sms2" name = "dept_name" type = "text" value = "${dept.deptName}"/>
				  		</div>
				  </fieldset>
